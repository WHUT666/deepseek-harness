...
const LINK_MAP: Record<string, string> = {
  ...
  LlmTurboCandidate: 'llm-turbo.md',
  LlmTurboCandidatesEventData: 'llm-turbo.md',
  LlmTurboComparison: 'llm-turbo.md',
  LlmTurboProgressEventData: 'llm-turbo.md',
  LlmTurboVerdictEventData: 'llm-turbo.md',
