...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/fluent/fluent': { kind: 'indirect', reason: 'The provider registry delegates model rendering to dsh-tool-fluent.' },
  'packages/fluent/fluent-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-fluent.' },
