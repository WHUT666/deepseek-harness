...
| [fluent.md](fluent.md) | the ANSYS Fluent batch seam: `FluentRequest`/`Result`, `FluentProvider`/`Service`, two operations, `FluentError` |
...
| [llm-turbo.md](llm-turbo.md) | Opt-in best-of-N loop-stream events: candidate actions, majority/PPT verdicts, and post-hoc progress scores |
