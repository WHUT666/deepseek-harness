...
| [fluent.md](fluent.md) | ANSYS Fluent 批量 seam：`FluentRequest`/`Result`、`FluentProvider`/`Service`、两种操作、`FluentError` |
...
| [llm-turbo.md](llm-turbo.md) | 显式启用的 loop 流 best-of-N 事件：候选 action、多数票／PPT 裁决与事后 progress 分数 |
