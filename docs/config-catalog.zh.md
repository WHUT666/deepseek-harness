...
来源：[`packages/experimental/llm-turbo/src/index.ts:105`](../packages/experimental/llm-turbo/src/index.ts)
...
来源：[`packages/fluent/fluent/src/index.ts:68`](../packages/fluent/fluent/src/index.ts)

<a id="deepseek-aidsh-fluent-local"></a>

## `@deepseek-ai/dsh-fluent-local`

需要：`fluent` · `subprocess`
...
依赖：[`FluentDimension`](../packages/fluent/fluent/src/index.ts)

来源：[`packages/fluent/fluent-local/src/index.ts:43`](../packages/fluent/fluent-local/src/index.ts)
...
来源：[`packages/fluent/tool-fluent/src/index.ts:72`](../packages/fluent/tool-fluent/src/index.ts)
